...
<html>
	<head>
		...
		<link rel="stylesheet" href="<?php echo e(asset('plugins/material-design-iconic-font/css/material-design-iconic-font.min.css')); ?>" type="text/css">

		<!-- STYLE CSS -->
		<link rel="stylesheet" href="<?php echo e(asset('css/register/style.css')); ?>">
	</head>
		...
		<div class="wrapper" style="background-color: #ebeeef">
			<div class="inner">
				<div class="image-holder">
					<img src="<?php echo e(asset('images/skeleton.gif')); ?>" alt="iq">
				</div>
