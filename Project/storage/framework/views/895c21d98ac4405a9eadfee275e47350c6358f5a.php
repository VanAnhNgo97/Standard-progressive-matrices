					...
					<div class="tab_panels">
						...
						<div class="tab_panel description active">
							...
							<div class="faqs" id="quiz_container">
								<?php echo $__env->make('quiz_container', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
...
<link rel="stylesheet" type="text/css" href="<?php echo e(asset('css/course.css')); ?>">
<link rel="stylesheet" type="text/css" href="<?php echo e(asset('css/course_responsive.css')); ?>">
<link rel="stylesheet" type="text/css" 
	  href="<?php echo e(asset('plugins/iziModal/css/iziModal.css')); ?>">
...
<script src="<?php echo e(asset('plugins/iziModal/js/iziModal.js')); ?>"></script>
<script src="<?php echo e(asset('js/course.js')); ?>"></script>
<script src="<?php echo e(asset('js/raven_test.js')); ?>"></script>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout/_shared', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>